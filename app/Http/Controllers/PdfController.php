...
class PdfController extends Controller
{
    ...
    public function gerarPdf()
    {
        ...
        $B = array($array_linhaB[0],$array_linhaI[0],$array_linhaN[0],$array_linhaN[0],$array_linhaO[0]);
        $I = array($array_linhaB[1],$array_linhaI[1],$array_linhaN[1],$array_linhaN[1],$array_linhaO[1]);
        $N = array($array_linhaB[2],$array_linhaI[2],$array_linhaN[2],$array_linhaN[2],$array_linhaO[2]);
        $G = array($array_linhaB[3],$array_linhaI[3],$array_linhaN[3],$array_linhaN[3],$array_linhaO[3]);
        $O = array($array_linhaB[4],$array_linhaI[4],$array_linhaN[4],$array_linhaN[4],$array_linhaO[4]);
