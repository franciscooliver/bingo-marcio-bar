...
Route::get('/cartelas', 'CartelaController@cartelas')->name('cartelas');
Route::get('/editCart/{id}', 'CartelaController@editCart')->name('editCart');
Route::put('/teste/{id}', 'CartelaController@teste')->name('cart.teste');
