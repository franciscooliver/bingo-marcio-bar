...
<head>
    ...
    <style>
      ...
      header{
        ...
        .dados-premios .premio-01{font-size: 20px; border: none; text-align: left; padding: 0; width: 24%; margin-bottom: 0px;font-weight: normal;}
        .dados-premios .premio-02{font-size: 20px; border: none; text-align: left; padding: 2px 0; width: 24%; font-weight: normal;}
        .dados-premios .premio-03{font-size: 20px; border: none; text-align: left;  padding: 0; font-weight: normal;}
        .dados-premios .premio-04{font-size: 20px; border: none; text-align: left;  padding: 0; width: 70%; font-weight: normal;}
        .dados-premios .premio-05{font-size: 20px; border: none; text-align: left;  padding: 0; width: 30%;font-weight: normal; }
...
?>
    <small id="small-2">Cartela: {{ $dados_cartelas["numero_cart"] }}</small>
    <img src="data:image/png;base64,{{ $dados_cartelas["barcode"] }}" alt="barcode" id="barcode-2">
   ...
   <header>
       ...
       <hr>
            ...
            <table class="dados-premios" width="100%">
                <tr>
            ...
            <table width="30%" border="1" cellspacing="0" cellpadding="5" align="center" style="border-collapse: collapse; margin-top: 1%;">
                ...
                <tbody>
                @foreach($dados_cartelas["linhas"] as $nums)
                    <tr class="bordered">
...
<table class="dados-premios" width="100%">
    <tr>
        <th class="premio-04">4° prêmio</th>
        <th class="premio-05">5° prêmio</th>

    </tr>
    <tr>
        <th class="premio-04">Uma caixa de cerveja</th>
        <th class="premio-05">Uma caixa de cerveja e um frango assado</th>
    </tr>
</table>
<table width="30%"  border="1" cellspacing="0" cellpadding="5" align="left" style="border: thin; border-style: solid;">
    <thead>
    <tr>
        <th>B</th>
        <th>I</th>
...
<table width="30%"  border="1" cellspacing="0" cellpadding="5" align="right" style="border: thin; border-style: solid; " id="table-5">
    <thead>
    <tr>
        <th>B</th>
        <th>I</th>
